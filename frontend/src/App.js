...
import { Phone, Mail, MapPin, Home, Building, LandPlot, Warehouse, CheckCircle, User } from "lucide-react";
  ...
  >
    ...
    <div className="hero-content px-4 max-w-4xl mx-auto">
      ...
      <Button 
        ...
        className="bg-[#0079e8] hover:bg-[#0062bd] text-white text-lg px-8 py-6 rounded-full font-semibold btn-animate animate-fade-in-up animation-delay-200"
