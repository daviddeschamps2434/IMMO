...
export const SEOHead = ({ 
  ...
  return (
    <Helmet>
      ...
      <meta name="description" content={description || 'Agent immobilier BSK sur Lauzerte, Montcuq et Montaigu-de-Quercy. Accompagnement personnalisé pour vendre ou acheter votre bien.'} />
